...
@Getter
@Builder
public class JobListFilter implements JmFilter<JobEntity> {
    ...
    public Specification<JobEntity> toSpecification() {
        ...
        specification = specification.and((root, query, criteriaBuilder) ->
                criteriaBuilder.equal(root.get("companyId"), this.companyId));

        if (this.status != null) {
            specification = specification.and((root, query, criteriaBuilder) ->
                    criteriaBuilder.equal(root.get("status"), this.status));
        }
